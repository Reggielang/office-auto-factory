...
class BasicInputInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/basic_input/check_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            comboBox,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/basic_input/combo_box/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            radioWidget,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/basic_input/radio_button/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            slider,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/basic_input/slider/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.switchButton,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/basic_input/switch_button/demo.py'
        )
