...
class MenuInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            self.button1,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/menu/menu/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            self.button3,
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/menu/widget_menu/demo.py'
        )
        ...
        self.addExampleCard(
            ...
            'https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/menu/command_bar/demo.py',
            stretch=1
        )
