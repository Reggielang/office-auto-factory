...
class NavigationViewInterface(GalleryInterface):
    ...
    def __init__(self, parent=None):
        ...
        self.addExampleCard(
            ...
            widget=breadcrumb,
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/navigation/breadcrumb_bar/demo.py',
            stretch=1
        )
        ...
        self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/navigation/pivot/demo.py'
        )
        ...
        card = self.addExampleCard(
            ...
            sourcePath='https://github.com/zhiyiYo/PyQt-Fluent-Widgets/blob/PyQt6/examples/navigation/tab_view/demo.py',
            stretch=1
        )
